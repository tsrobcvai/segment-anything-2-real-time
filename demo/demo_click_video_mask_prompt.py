...
INPUT_VIDEO = "../notebooks/videos/merged_webcam_2.mp4"  
OUTPUT_VIDEO = "../notebooks/videos/masked_webcam_2_test.mp4" # webcam_2_masked.mp4
TARGET_MASK = "../notebooks/videos/first_frame_mask.png"
...
def main():
    ...
    target_mask = cv2.imread(TARGET_MASK, cv2.IMREAD_UNCHANGED)
    ...
    while True:
        ...
        object_ids, video_res_masks = predictor.track(frame_resized_rgb)
        ...
        for i in range(len(object_ids)):
            ...
            m = (video_res_masks[i] > 0).squeeze(0).cpu().numpy().astype(np.uint8) * 255
